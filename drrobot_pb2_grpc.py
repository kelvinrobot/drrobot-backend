...
import drrobot_pb2 as drrobot__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in drrobot_pb2_grpc.py depends on'
...
class DoctorRobotServicer(object):
    """Service definition if gRPC is intended
    """
...
def add_DoctorRobotServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'drrobot.DoctorRobot', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('drrobot.DoctorRobot', rpc_method_handlers)
